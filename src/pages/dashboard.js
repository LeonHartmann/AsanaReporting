    ...
    <>
      ...
      <div>
        ...
        <div id="capture-content">
             ...
             <div id="export-task-summary"> {/* Removed max-w-screen-2xl mx-auto */}
                {!error && (
                  <TaskSummary 
                    tasks={tasks} 
             ...
             <div id="export-avg-time-status"> {/* Removed max-w-screen-2xl mx-auto */}
                {!isLoading && !error && (
             ...
             <div id="export-chart-grid" className="mb-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"> {/* Removed max-w-screen-2xl mx-auto */}
             ...
             <div id="export-trend-chart" className="mb-8"> {/* Removed max-w-screen-2xl mx-auto */}
